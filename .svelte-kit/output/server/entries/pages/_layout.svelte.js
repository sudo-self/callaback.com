...
function Footer($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    const socialLinks = [
      {
        icon: "twitter",
        url: "https://twitter.com/lightfighter719",
        label: "Twitter"
      },
      {
        icon: "github",
